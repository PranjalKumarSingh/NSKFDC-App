...
CREATE TABLE `batchdetails` (
  ...
  `principalTrainerName` varchar(200) DEFAULT NULL,
...
CREATE TABLE `candidate` (
  `enrollmentNumber` varchar(150) NOT NULL,
  ...
  `hiredByMc` varchar(4) DEFAULT NULL,
  `outsourcedEmployerName` varchar(200) DEFAULT NULL,
  `outsourcedEmployerContact` bigint(20) DEFAULT NULL,
  `monthlySalary` bigint(20) DEFAULT NULL,
  `pfOrEsiProvided` varchar(4) DEFAULT NULL,
  `batchId` varchar(200) DEFAULT NULL,
